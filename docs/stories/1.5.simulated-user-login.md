...
- [x] Task 2: Implement input fields (AC: 2)
  - [x] Add username/email TextField with proper styling and validation
  - [x] Add password TextField with obscured text and visibility toggle
  - [x] Implement proper form field decorations and Material 3 styling
  - [x] Add input field labels and placeholder text

- [x] Task 3: Create Login button (AC: 2)
  - [x] Add elevated Login button with proper Material 3 styling
  - [x] Implement button tap handler for navigation
  - [x] Add loading state indication (optional for this story)
  - [x] Ensure button is properly sized and positioned

- [x] Task 4: Implement navigation to main shell (AC: 3)
  - [x] Import MainNavigationScreen from Story 1.4
  - [x] Implement navigation using Navigator.pushReplacement
...
- Placeholder: "Enter your email" or "Enter your username"
- Keyboard type: email or text
- Validation: Basic non-empty validation
...
- **Real Authentication:** Future JWT token-based authentication
- **Google OAuth:** Integration with Google OAuth (Story 1.3 dependency)
